...
namespace Microsoft.Azure.Batch.SoftwareEntitlement
{
    ...
    public class EntitlementVerificationRequest
    {
        ...
        /// </summary>
        /// <param name="application">The identifier for the application the entitlement is being requested for</param>
        /// <param name="ipAddress">The observed IP address of the machine requesting the entitlement</param>
        public EntitlementVerificationRequest(string application, IPAddress ipAddress)
        {
